<?php
	require_once("action/Personnel_scientifique_Action.php");
	$action = new Personnel_scientifique_Action();
	$action->execute();
		...
		<div class="col-sm-5">
			<div class="widget widget-categories">
				<ul>
					...
					<li class="active"><a href="personnel_scientifique.php">Personnel scientifique</a></li>
