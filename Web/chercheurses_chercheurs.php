<?php
	require_once("action/Chercheurses_chercheurs_Action.php");
	$action = new Chercheurses_chercheurs_Action();
	$action->execute();
		...
		<div class="col-sm-5">
			<div class="widget widget-categories">
				<ul>
					...
					<li class="active"><a href="chercheurses_chercheurs.php">Chercheuses et chercheurs affiliés</a></li>
