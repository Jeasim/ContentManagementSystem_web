<?php
	require_once("action/Personnel_administratif_Action.php");
	$action = new Personnel_administratif_Action();
	$action->execute();
	...
	<div class="row">
		...
		<div class="col-sm-5">
			<div class="widget widget-categories">
				<ul>
					<li class="active"><a href="personnel_administratif">Personnel administratif</a></li>
